"""
Mock customer data — Fina (cust_00131).
Fina is used to demonstrate safety retry recovery.
She passes Data Checker and produces one fact: dormant_feature for Gold Savings (PAXG).
On first attempt, LLM returns a mild safety violation ("We recommend"), which gets rewritten and successfully published.
"""
...
transactions = [
    {"transaction_id": "tx501", "customer_id": CUSTOMER_ID, "date": "2026-06-01", "category": "groceries", "amount": 3500, "type": "debit", "description": "Supermarket purchase"},
    {"transaction_id": "tx502", "customer_id": CUSTOMER_ID, "date": "2026-06-15", "category": "salary", "amount": 30000, "type": "credit", "description": "Salary payout"},
]
